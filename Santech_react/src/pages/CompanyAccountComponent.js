...
class CompanyAccountComponent extends React.Component {
  ...
  async formSubmit(event) {
    ...
    this.updateDataAgain(); // Mettre à jour les données après l'envoi
  }

  // Méthode appelée après le montage du composant, chargement initial des données
  componentDidMount() {
    this.fetchCompanyAccountData();
  }

  // Récupère les données des comptes d'entreprise
  ...
  // Met à jour les données des comptes d'entreprise
