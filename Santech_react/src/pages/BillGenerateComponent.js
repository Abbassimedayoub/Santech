...
class BillGenerateComponent extends React.Component {
  ...
  // Ajoute une nouvelle ligne de détails de médicaments
  AddMedicineDetails = () => {
  ...
  // Supprime la dernière ligne de détails de médicaments
  RemoveMedicineDetails = () => {
    ...
    // Met à jour les détails du médicament lorsqu'un médicament est sélectionné
  showDataInInputs = (index, item) => {// Logique pour mettre à jour l'état avec les détails du médicament
    console.log(index);
    console.log(item);
    ...
    this.state.medicineDetails[index].TVA = item.TVA;
    this.state.medicineDetails[index].medicine_name = item.name;
    this.state.medicineDetails[index].amount =
      parseInt(item.sell_price) + parseInt(item.TVA) ;
    this.setState({});
  };
  // Met à jour la quantité et le montant total lorsque la quantité est modifiée
  qtyChangeUpdate = (event) => {
    var value = event.target.value;
    var index = event.target.dataset.index;
    // Logique pour calculer et mettre à jour le montant total
    this.state.medicineDetails[index].amount =
      (parseInt(this.state.medicineDetails[index].unit_price) +
        parseInt(this.state.medicineDetails[index].TVA)) *
      value;
  ...
  render() {
    return (
      ...
      {/* Structure de la page de génération de facture */}
